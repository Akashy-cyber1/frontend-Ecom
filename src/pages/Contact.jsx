    ...
    <div>
      ...
      <div className='flex flex-col justify-center gap-10 my-10 md:flex-row mb-28'>
        ...
        <div className='flex flex-col items-start justify-center gap-6'>
          ...
          <p className='text-gray-500'>Trendify 354 Fashion Lane <br />Noida, 201301, Utter pradesh</p>
          <p className='text-gray-500'>Tel: (+91)7007592695 <br />Email: akashy1935@hmail.com</p>
          <p className='text-xl font-semibold text-gray-600'>Careers at Forever</p>
          <p className='text-gray-500'>Join us at Trendify!  the future of fashion. <br />Explore our current job openings and discover how you can contribute to our mission of setting trends and creating style.</p>
